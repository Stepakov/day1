            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        $employees = $res->fetchAll(PDO::FETCH_ASSOC);
//                        echo "<pre>";
//
//
//                        print_r( $employees );
...
//                        $employees = [];
                        ...
                        <div class="<?php if( $employee[ 'is_banned' ] ) echo 'banned ' ?>rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            ...
                            <div class="ml-2 mr-3">
                                ...
                                <a href="https://wrapbootstrap.com/user/<?= $employee[ 'wrapbootstrap' ] ?>" class="text-info fs-sm" target="_blank" title="Contact <?= $employee[ 'name' ] ?>"><i class="fal fa-envelope"></i></a>
                            </div>
                        </div>
                        <?php endforeach; ?>
